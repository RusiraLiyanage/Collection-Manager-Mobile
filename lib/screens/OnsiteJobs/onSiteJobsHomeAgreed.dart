...
class OnsiteJobsHomeAgreed extends StatefulWidget {
  ...
  @override
  State<OnsiteJobsHomeAgreed> createState() => _onSiteJobsHomeAgreedState();
}

class _onSiteJobsHomeAgreedState extends State<OnsiteJobsHomeAgreed> {
