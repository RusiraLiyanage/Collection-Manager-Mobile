...
import 'package:project_code_blue/screens/ClientManagement/Data/clientManagementData.dart';
...
class _ClientManagementState extends State<ClientManagement> {
  ...
  final List<Map<String, String>> clientData =
      ClientManagementData().clientsData;
  ...
  final List<Map<String, String>> clientDataAchieved =
      ClientManagementData().clientsDataAchieved;
